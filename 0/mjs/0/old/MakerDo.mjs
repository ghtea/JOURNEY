...
function MakerDo({forceRerender}) {
  
  
  function addDo(event) {
   /*event.stopPropagation();*/

const inputText = document.querySelector(".divAddBookmark .inputTitle");

const inputTimeStart = document.querySelector(".divAddBookmark .inputUrl");
